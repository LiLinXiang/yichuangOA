    ...
    <div class="mainContent">
        ...
        <el-form class="formContent" ref="form" label-width="80px">
            ...
            <div style="margin-bottom:1.5rem ">
                ...
                <vue-ueditor-wrap class="ueditor-wrap" v-model="msg" :config="myConfig" style="margin-left: 80px;"></vue-ueditor-wrap>
            </div>
        ...
        <div class="form-footbar">
            <el-button class="save-botton btn-green" type="primary">保存产品信息</el-button>
